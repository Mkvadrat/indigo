...
class ControllerBlogLatest extends Controller { 	
	public function index() { 
		...
		foreach ($results as $result) {
			...
			}elseif($this->config->get('configblog_image_article_height') && $this->config->get('configblog_image_article_width')){
				$height_orig = $this->config->get('configblog_image_article_height');
				$width_orig = $this->config->get('configblog_image_article_width');
			}
