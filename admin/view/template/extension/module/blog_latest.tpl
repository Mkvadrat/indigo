    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-latest" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-html">Описание:</label>
            <div class="col-sm-10">
              <textarea name="html" placeholder="Описание" rows="5" id="input-html" class="form-control summernote"><?php echo $html; ?></textarea>
            </div>
          </div>
          <div class="form-group">
