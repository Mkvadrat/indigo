        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-fmainblock" class="form-horizontal">
          ...
          <div class="tab-pane">
            ...
            <div class="tab-content">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="thumb-fimage">Изображение 1</label>
                <div class="col-sm-10">
                  <a href="" id="thumb-fimage" data-toggle="image" class="img-thumbnail"><img src="<?php echo $fthumb; ?>" alt="" title=""  /></a><input type="hidden" name="fimage" value="<?php echo $fimage; ?>" id="input-fimage" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="thumb-simage">Изображение 2</label>
                <div class="col-sm-10">
                  <a href="" id="thumb-simage" data-toggle="image" class="img-thumbnail"><img src="<?php echo $sthumb; ?>" alt="" title=""  /></a><input type="hidden" name="simage" value="<?php echo $simage; ?>" id="input-simage" />
                </div>
              </div>
              <?php foreach ($languages as $language) { ?>
