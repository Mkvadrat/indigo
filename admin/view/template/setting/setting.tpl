        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="store-language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-link<?php echo $language['language_id']; ?>">Ссылка на форму обратной связи (Шапка сайта)</label>
                    <div class="col-sm-10">
                      <textarea name="config_langdata[<?php echo $language['language_id']; ?>][callback_link]" placeholder="Ссылка на форму обратной связи" rows="5" id="input-link<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['callback_link'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-messenger<?php echo $language['language_id']; ?>">Viber, WhatsApp (Шапка сайта)</label>
                    <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mobile-logo">Логотип для мобильной версии</label>
                <div class="col-sm-10"><a href="" id="thumb-mobile-logo" data-toggle="image" class="img-thumbnail"><img src="<?php echo $mobile_logo; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_mobile_logo" value="<?php echo $config_mobile_logo; ?>" id="input-mobile-logo" />
                </div>
              </div>
              <div class="form-group">
